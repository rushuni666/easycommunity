...
public class UserService implements EasyCommunityConstant {
    ...
    @Value("${easycommunity.path.domain}")
...
//        return userMapper.selectById(id);
    ...
    public Map<String, Object> register(User user) {
        ...
        // 注册用户
        user.setSalt(EasyCommunityUtils.generateUUID().substring(0, 5));
        user.setPassword(EasyCommunityUtils.md5(user.getPassword() + user.getSalt()));
        user.setType(0);
        user.setStatus(0);
        user.setActivationCode(EasyCommunityUtils.generateUUID());
        String gravatar = "http://www.gravatar.com/avatar/{%d}?s=50&d=robohash";
//        http://www.gravatar.com/avatar/{23}?s=50&d=retro
    ...
    public Map<String, Object> login(String username, String password, int expiredSeconds) {
        ...
        // 验证密码
        password = EasyCommunityUtils.md5(password + user.getSalt());
        ...
        loginTicket.setTicket(EasyCommunityUtils.generateUUID());
